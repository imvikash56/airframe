      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=> {navigate('/')}}>
              ...
              <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=> {navigate('/system')}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=> {navigate('/monitor')}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=> {navigate('/financial')}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary='Financial' sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
              </ListItem>
